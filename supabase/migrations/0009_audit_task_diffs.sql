-- Audit îmbunătățit: la modificarea sarcinilor, reține și valorile VECHI (din→în)
-- pentru stare / prioritate / responsabil / titlu / termen. Plus o funcție care
-- întoarce istoricul unei sarcini, vizibil userilor autentificați (nu doar admin).
...
-- Istoricul unei sarcini (doar rândurile de tip „tasks" pentru acel id),
-- vizibil oricărui utilizator autentificat (sarcinile sunt oricum comune).
